...
class TrainingArguments:
    experiment_name: str = field(
        default="default", metadata={"help": "Experiment name."}
    )
    ...
    tracker: Literal["tensorboard", "wandb"] = field(
        default=None, metadata={"help": "Tracker to use. Default: None (no tracker)."}
    )
    ...
    use_lora: bool = field(default=False, metadata={"help": "Finetuning with LoRA."})
    lora_rank: int = field(
    ...
    def __post_init__(self):
        ...
        if os.path.exists(self.output_dir) and self.overwrite_output_dir:
